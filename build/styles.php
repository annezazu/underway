 ...
 *
 * Note: These styles can be overridden by calling underway_override_style()
 ...
 */
function underway_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function underway_register_package_styles( $styles ) {
...
add_action( 'wp_default_styles', 'underway_register_package_styles' );
