 ...
 *                                    Default 'false'.
 */
function underway_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function underway_register_package_scripts( $scripts ) {
...
add_action( 'wp_default_scripts', 'underway_register_package_scripts' );
