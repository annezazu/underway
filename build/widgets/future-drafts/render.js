...
// widgets/future-drafts/render.scss
...
function FutureDraftsWidget(_props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "underway-widget", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { className: "components-button is-primary", href: "edit.php?post_status=future&post_type=post", children: (0, import_i18n.__)("See scheduled posts", "underway") })
  ] });
}
export {
